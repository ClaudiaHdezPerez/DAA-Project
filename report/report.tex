...
\begin{itemize}
    ...
    \begin{itemize}
        \item $n$: número de puertos.
        \item $m$: número de ítems diferentes (se asume igual en todos los puertos por comodidad).
...
$|L| \leq m$, por lo que el espacio de decisiones por puerto es $O(4^m)$.
...
El análisis completo se encuentra en el directorio \path{../src/validation}. 
...
la solución eficiente siempre se mantiene sobre el 70\% de la solución óptima.
